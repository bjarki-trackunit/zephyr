...
#define MODEM_CELLULAR_DEVICE_SIMCOM_SIM7080(inst)						\
	...
	static struct modem_cellular_config MODEM_CELLULAR_INST_NAME(config, inst) = {		\
		...
		.startup_time_ms = 10000,							\
		.shutdown_time_ms = 5000,							\
		.init_chat_script = &simcom_sim7080_ppp_init_chat_script,			\
		.dial_chat_script = &simcom_sim7080_ppp_dial_chat_script,			\
	};											\
												\
	PM_DEVICE_DT_INST_DEFINE(inst, modem_cellular_pm_action);				\
												\
...
#define MODEM_CELLULAR_DEVICE_U_BLOX_SARA_R4(inst)						\
	...
	static struct modem_cellular_config MODEM_CELLULAR_INST_NAME(config, inst) = {		\
		...
		.startup_time_ms = 10000,							\
		.shutdown_time_ms = 5000,							\
		.init_chat_script = &u_blox_sara_r4_ppp_init_chat_script,			\
		.dial_chat_script = &u_blox_sara_r4_ppp_dial_chat_script,			\
	};											\
												\
	PM_DEVICE_DT_INST_DEFINE(inst, modem_cellular_pm_action);				\
												\
...
#define MODEM_CELLULAR_DEVICE_SWIR_HL7800(inst)							\
	...
	static struct modem_cellular_config MODEM_CELLULAR_INST_NAME(config, inst) = {		\
		...
		.startup_time_ms = 10000,							\
		.shutdown_time_ms = 5000,							\
		.init_chat_script = &swir_hl7800_ppp_init_chat_script,				\
		.dial_chat_script = &swir_hl7800_ppp_dial_chat_script,				\
	};											\
												\
	PM_DEVICE_DT_INST_DEFINE(inst, modem_cellular_pm_action);				\
												\
...
#define MODEM_CELLULAR_DEVICE_TELIT_ME910G1(inst)						\
	...
	static struct modem_cellular_config MODEM_CELLULAR_INST_NAME(config, inst) = {		\
		...
		.startup_time_ms = 10000,							\
		.shutdown_time_ms = 5000,							\
		.init_chat_script = &telit_me910g1_ppp_init_chat_script,			\
		.dial_chat_script = &telit_me910g1_ppp_dial_chat_script,			\
	};											\
												\
	PM_DEVICE_DT_INST_DEFINE(inst, modem_cellular_pm_action);				\
												\
